...
from albert.graph import optimize_graph

import tensorflow  as tf
from albert import modeling
from albert import tokenization
from albert import args
...
class BertVector:
    def __init__(self, batch_size=32, pooling_strategy="REDUCE_MEAN", max_seq_len=40,gpu_memory_fraction=0.5):
        """
        init BertVector
    ...
    def input_fn_builder(self, features, seq_length):
        ...
        def input_fn(params):
            ...
            d = tf.data.Dataset.from_tensor_slices({
                "guids":
                    tf.constant(all_guids, shape=[num_examples], dtype=tf.int32),
                "input_ids":
                    tf.constant(
