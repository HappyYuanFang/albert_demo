...
from albert.args import PoolingStrategy
import contextlib
...
def optimize_graph(logger=None, verbose=False, pooling_strategy=PoolingStrategy.REDUCE_MEAN, max_seq_len=40):
    ...
    try:
        ...
        input_ids = tf.placeholder(tf.int64, (None, max_seq_len), 'input_ids')
        input_mask = tf.placeholder(tf.int64, (None, max_seq_len), 'input_mask')
        segment_ids = tf.placeholder(tf.int64, (None, max_seq_len), 'segment_ids')
